...
function Delete() {
    ...
    if (trNum == 1 && count != 1) {
        ...
        span.insertAdjacentHTML('afterend', '<input type="button" onclick="Add(this)" value="Add" style="margin: 10px 0px; width: 150px; height: 35px; border-radius: 16px; border: none; background-color: #bac8d5e0; color: #5e5c5c; font-weight: 600;" required />');
    }
    else if (trNum == 2) {
        var span = document.getElementById('span1');
        span.insertAdjacentHTML('afterend', '<input type="button" onclick="Add(this)" value="Add" style="margin: 10px 0px; width: 150px; height: 35px; border-radius: 16px; border: none; background-color: #bac8d5e0; color: #5e5c5c; font-weight: 600;" />');
    }
