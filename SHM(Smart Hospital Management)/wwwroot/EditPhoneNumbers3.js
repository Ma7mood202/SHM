...
function Add(btn) {
    if (count < 3) {
        ...
        var valueToAdd = '   <tr id="tr' + trNum + '" style=" display: flex; flex-direction: column;padding: 10px; margin: 10px; border-width: 1px; border-color: lightgray; border-radius: 20px;">' +
            ...
            '<input type="button" onclick="Add(this)" value="Add" style="margin: 10px 0px; width: 150px; height: 35px; border-radius: 16px; border: none; background-color: #bac8d5e0; color: #5e5c5c; font-weight: 600;" /></div></td>' +
            ' </tr>';
